...
def load_data(
    *,
    ...
    dataset = MultimodalDataset(
        ...
        shard = th.distributed.get_rank(),
        num_shards = th.distributed.get_world_size(),
...
class MultimodalDataset(Dataset):
    ...
    def get_item(self, idx):
        ...
        raw_audio =  AudioFileClip(video_path, fps=audio_fps).subclipped(start_t, end_t)
...
if __name__=='__main__':
    ...
    dataset64=load_data(
    data_dir="./data10/landscape/test",
