...
# Modify --devices according your GPU number--devices 0,1,2,3
...
OUT_DIR="./output/dpm_solver"
REF_PATH="./data10/AIST++_crop/train"

NUM_GPUS=1
mpiexec --use-hwthread-cpus -n $NUM_GPUS python3 py_scripts/multimodal_sample_sr.py  \
