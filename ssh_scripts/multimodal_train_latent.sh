...
--devices 0,1,2,3 --log_interval 100 --save_interval 3 --use_db False " #--schedule_sampler loss-second-moment


DIFFUSION_FLAGS="--noise_schedule linear --diffusion_steps 3 --save_type mp4 --sample_fn ddpm" 
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/py_scripts/ALEJANDRO_multimodal_train_multiprocessing.py  --data_dir ${DATA_DIR} --output_dir ${OUTPUT_DIR} $MODEL_FLAGS $TRAIN_FLAGS $DIFFUSION_FLAGS"
${CMD}
